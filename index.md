...
10.(with Zhonghua Li, Yutong Song and Shengbo Zhao) *Large values of character sums with multiplicative coefficients*, [arXiv:2508.09750](http://arxiv.org/abs/2508.09750)

11.(with Weijia Wang and Hao Zhang) *Almost meromorphic modular forms and their associated L-functions*

12.(with Yanbin Zhang) *Large values of quadratic character sums*

13.(with Zhonghua Li, Yutong Song and Shengbo Zhao) *Large values of quadratic L-functions near the central point*
## Some links: 
